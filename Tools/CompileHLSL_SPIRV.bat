...
dxc -T vs_5_0 -E main ..\Source\SolutionVS\Demo\sample_vs.hlsl -Fo ..\Bin\sample_vs.spv
dxc -T ps_5_0 -E main ..\Source\SolutionVS\Demo\sample_ps.hlsl -Fo ..\Bin\sample_ps.spv
PAUSE