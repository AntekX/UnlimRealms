...
#include "../include/IL/il_palette.h"
...
ILAPI ILboolean ILAPIENTRY il2InitImage     (ILimage *Image, ILuint Width, ILuint Height, ILuint Depth, ILubyte Bpp, ILenum Format, ILenum Type, void *Data, ILboolean allocDataBuffer = true);
